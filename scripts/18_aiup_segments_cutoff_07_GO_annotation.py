...
# print(list(dict.items())[:5])

#print(type (acc_numbers))
#print(acc_numbers)
#print(list(gaf_Subset.items())[:1])
# print(type(next(iter(gaf_Subset.values()))))
# print(functional_annotation_df)

#Need these fo rht enrichmentAnalysis():  GOdict,
#     gafDict,
#     gafSubset,
#     minGenes=3,
#     threshold=0.05,
#     propagation=True
# )
#GOdict: generated by obo_tools.importOBO() ....obo_tools -> path of the obo file
#gafDict: gaf_parser.importGAF(path,geneSet):
#gafSubset: using again import GAF but using the geneSet option:filter on the interested genes: using the acc number list from 0.7 cutoff list
#interested genes: from the 0.7 cutoff file create a list of the accession numbers

# print(dir(obo_tools))
#help(obo_tools.importOBO) #: path to the obo file is needed
# print(dir(gaf_parser))
#help(gaf_parser.importGAF): path to the gaf file is needed
#gafSubest: dictionary with the accession numbers
# print(dir(enrichment_stats))
#help(enrichment_stats.enrichmentAnalysis)
# help(obo_tools)
