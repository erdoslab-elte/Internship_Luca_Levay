...
iup_overlap_above_tsv=pd.read_csv("/home/guest/Internship/results/Interproscan_Gene3D/05_gene3d_iupred_overlap_above_50.tsv",sep="\t")
iup_overlap_below_tsv=pd.read_csv("/home/guest/Internship/results/Interproscan_Gene3D/05_gene3d_iupred_overlap_below_50.tsv",sep="\t")
aiup_overlap_above_tsv=pd.read_csv("/home/guest/Internship/results/Interproscan_Gene3D/05_gene3d_aiupred_overlap_above_50.tsv",sep="\t")
aiup_overlap_below_tsv=pd.read_csv("/home/guest/Internship/results/Interproscan_Gene3D/05_gene3d_aiupred_overlap_below_50.tsv",sep="\t")
...
with open("/home/guest/Internship/results/Interproscan_Gene3D/07_gene3d_percentage_overlapping_regions.txt","w") as file:
