...
#Iupred2a
pfam_iup_above = pd.read_csv("/home/guest/Internship/results/Interproscan_Pfam/04_pfam_iupred_overlap_above_50.tsv",sep="\t")
pfam_iup_below = pd.read_csv("/home/guest/Internship/results/Interproscan_Pfam/04_pfam_iupred_overlap_below_50.tsv",sep="\t")

#Aiupred
pfam_aiup_above = pd.read_csv("/home/guest/Internship/results/Interproscan_Pfam/04_pfam_aiupred_overlap_above_50.tsv",sep="\t")
pfam_aiup_below = pd.read_csv("/home/guest/Internship/results/Interproscan_Pfam/04_pfam_aiupred_overlap_below_50.tsv",sep="\t")
...
for index, iup_above_row in pfam_iup_above.iterrows():
...
for index, iup_below_row in pfam_iup_below.iterrows():
...
for index, aiup_above_row in pfam_aiup_above.iterrows():
...
for index, aiup_below_row in pfam_aiup_below.iterrows():
